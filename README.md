...
3. Wait a few minutes for the web to be deployed. It will be available at: `https://{github-username}.github.io/{repository-name}/{location-inside-repository}`. In this case: `https://david-lor.github.io/telegram-web-app-bot-example/index.html`
...
1. Show the user a special menu button (near the message input field):
    ...
    4. Send a URL to your Web App (in this case, `https://david-lor.github.io/telegram-web-app-bot-example/index.html`)
